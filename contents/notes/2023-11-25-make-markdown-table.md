...
![policyf](/assets/notes/2023-11-03-make-markdown-table/policy.png)
...
3. `キー バインド` をクリックし、下図のとおりキーバインドを設定する。
    ...
    ![swap-keybindings](/assets/notes/2023-11-03-make-markdown-table/swap-keybindings.png)
...
![obsidian-swap-ud](/assets/notes/2023-11-03-make-markdown-table/obsidian-swap-ud.png)

![obsidian-swap-lr](/assets/notes/2023-11-03-make-markdown-table/obsidian-swap-lr.png)
